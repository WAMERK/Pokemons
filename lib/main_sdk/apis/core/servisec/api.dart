...
import 'package:pokemon/main_sdk/apis/core/models/common/model.dart';
...
import 'package:pokemon/main_sdk/utils/_dio_logging_interceptors.dart';
    ...
    if (isCache) {
      final options = CacheOptions(
        store: HiveCacheStore(
            (await getApplicationDocumentsDirectory()).path), // Required.
